...
import { getAllEnquiries } from '@/redux/slice/EnquirySlice';
...
const eventTypes = useMemo<string[]>(() => {
  ...
  const filteredEnquiries = useMemo(() => {
    return enquiries.filter((enquiry) => {
      ...
      const matchesEvent =
        !eventType || enquiry.eventType === eventType;

      const matchesFromDate =
        !fromDate ||
        (enquiryDate && enquiryDate >= fromDate);
  ...
  }, [enquiries, search, eventType, fromDate, toDate]);
