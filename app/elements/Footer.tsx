...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#dcdad4] text-white py-16 px-6 border-2">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <h4 className="text-lg text-primary mb-6">Get In Touch</h4>
          ...
          <div>
            <h4 className="text-lg text-primary mb-6">Newsletter</h4>
